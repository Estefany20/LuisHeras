                        ...
                        <div class="card-body text-secondary">
                         @if(session()->has('msj'))
                           <div class="sufee-alert alert with-close alert-primary alert-dismissible fade show">
                            ...
                            @else
                        @endif
                            <div class="card-header">Maquinados y contrucciones</div>
                            <div class="card-body">
                                <div class="card-title">
                                    <h3 class="text-center title-2">Alta cliente</h3>
                                </div>
                                ...
                                {{csrf_field()}}
                                    ...
                                    @endif
                                        <label for="cc-payment" class="control-label mb-1">Id cliente</label>
                                        <input id="cc-pament" name="id_cliente" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{$idClientes}}" readonly ='readonly'>
                                    </div>
                                    ...
                                    @endif
                                        <input id="cc-pament" name="nombre_cliente" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('nombre_cliente')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @endif
                                        <input id="cc-pament" name="apellido_materno_cliente" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('apellido_materno_cliente')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @endif
                                        <input id="cc-pament" name="apellido_paterno_cliente" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('apellido_paterno_cliente')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @endif
                                        <input id="cc-pament" name="calle" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('calle')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @endif
                                        <input id="cc-pament" name="num" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('num')}}">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    @endif
                                        <input id="cc-pament" name="localidad" type="text" class="form-control"
                                            aria-required="true" aria-invalid="false" value="{{old('localidad')}}">
                                    </div>
                                    <div class="form-group">
