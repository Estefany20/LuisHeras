                        ...
                        @endif
                            ...
                            <div class="card-body">
                                ...
                                {{csrf_field()}}
                                    ...
                                    @endif
                                        <label for="cc-payment" class="control-label mb-1">Id empleado</label>
                                    ...
                                    @endif
                                        <input id="cc-pament" name="nombre_empleado" type="text" class="form-control"
                                    ...
                                    @endif
                                        <input id="cc-pament" name="apellido_materno_empleado" type="text" class="form-control"
                                    ...
                                    @endif
                                        <input id="cc-pament" name="apellido_paterno_empleado" type="text" class="form-control"
                                    ...
                                    @endif
                                        <input id="cc-pament" name="curp" type="text" class="form-control"
                                    ...
                                    @endif
                                        <input id="cc-pament" name="NSS" type="text" class="form-control"
                                    ...
                                    @endif
                                        <input id="cc-pament" name="fecha_ingreso" type="text" class="form-control"
